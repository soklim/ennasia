    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          ...
          {{--@endif--}}
          <form method="post" action="{{ route('sys_static.update',$sys_statics->id) }}" autocomplete="off" class="form-horizontal" enctype="multipart/form-data">
            @csrf
            @method('put')
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group">
                      <input class="form-control" name="static_name" type="text" value="{{ old('static_name', $sys_statics->static_name) }}" required="true" aria-required="true"/>
                    </div>
                  </div>
                </div>
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group">
                      <input class="form-control" name="value_en" type="text" value="{{ old('value_en', $sys_statics->value_en) }}" required="true" aria-required="true"/>
                    </div>
                  </div>
                </div>
                <div class="row">
