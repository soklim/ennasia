...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <title>{{ __('ENN ASIA Dashboard') }}</title>
    <link rel="apple-touch-icon" sizes="76x76" href="{{ asset('material') }}/img/favicon2.png">
    <link rel="icon" type="image/png" href="{{ asset('material') }}/img/favicon2.png">
